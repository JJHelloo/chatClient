...
def myNetwork():
    ...
    makeTerm( h1, title='h1', term='xterm', display=None, cmd='sudo python3 ~/CST311/chatServer.py')
    time.sleep(1)
    makeTerm( h2, title='h2', term='xterm', display=None, cmd='sudo python3 ~/CST311/chatClient.py')
    time.sleep(1)
    makeTerm( h3, title='h3', term='xterm', display=None, cmd='sudo python3 ~/CST311/chatClient.py')
