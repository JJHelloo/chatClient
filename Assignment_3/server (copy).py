...
# Pacific Analytics
# Server that receives connection from two devices
# Assigns a letter X to first device and Y to the second device
# waits for both devices to connect
# Accepts a message from both devices
# Prints out the message as the message is sent
# Sends the combined message to the client
...
def join():
  ...
  #time.sleep(1)
  #toll = "go"
  #connectionSocket.send(toll.encode())
  # send dummy info
  # resume = "resume"
  # connectionSocket.send(resume.encode())
