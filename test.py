...
def myNetwork():
  ...
  #changed ip addresses
    net.addLink( r3, r4, intfName1='r3-eth1', params1={ 'ip' : '192.168.0.2/30' }, intfName2='r4-eth0', params2={ 'ip' : '192.168.0.1/30' }, )
    #net.addLink( r3, r4, intfName1='r3', params1={ 'ip' : '192.168.2.2/30' }, intfName2='r4-eth0', params2={ 'ip' : '192.168.2.5/30' }, )
    net.addLink( r5, r4, intfName1='r5-eth1', params1={ 'ip' : '192.168.1.2/30' }, intfName2='r4-eth1', params2={ 'ip' : '192.168.1.1/30' }, )
